...
import otus.homework.customview.addDays
import otus.homework.customview.format
...
class GraphView : View {
    ...
    private val contentWidth: Int
        get() = periodWidth * yPeriods.size + rowPadding.toInt() * 2

    private var xPeriods: List<String> = emptyList()

    private var yPeriods: List<Int> = emptyList()

    private var points: List<GraphView.Point> = emptyList()
